...
`docs/OPERATOR_GUIDE.md` (reviewed 2026-09-10)
...
Этот файл сохраняет исходные требования первого pilot. Для текущего
post-pilot scope действует приоритет источников из `docs/AGENTS.md`, принятые
ADR и актуальные операторские инструкции. Реализованные WhatsApp templates,
channel health и прямые платежи в Meta описаны в `docs/WHATSAPP_MANAGEMENT.md`;
исходный MVP-план ниже не отменяет эти утверждённые возможности.
