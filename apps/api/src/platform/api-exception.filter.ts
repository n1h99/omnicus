...
export const SAFE_API_CODE_MESSAGES: Readonly<Record<string, string>> = {
  ...
  CHANNEL_CONNECTION_NOT_FOUND: 'The selected channel connection was not found',
  ...
  COMMUNICATION_IDENTITY_CHANNEL_MISMATCH: 'The selected identity does not belong to this channel',
  COMMUNICATION_IDENTITY_NOT_FOUND: 'The contact identity is no longer available for this channel',
  COMMUNICATION_IDENTITY_REQUIRED: 'Choose a contact identity before sending this message',
  COMMUNICATION_WHATSAPP_CONSENT_REQUIRED:
    'WhatsApp consent must be granted before sending an official template',
  COMMUNICATION_WHATSAPP_IDENTITY_CONFLICT:
    'This WhatsApp number is already linked to another contact',
  COMMUNICATION_WHATSAPP_PHONE_REQUIRED:
    'Add a valid phone number before starting a WhatsApp conversation',
  COMMUNICATION_WHATSAPP_RECIPIENT_BLOCKED: 'This recipient is not available for WhatsApp delivery',
  ...
  CRM_CONTACT_SYNC_IDEMPOTENCY_CONFLICT:
    'This CRM contact sync key was already used for different lead data',
  ...
  MEDIA_CHANNEL_INVALID: 'Choose Telegram or WhatsApp for this media file',
